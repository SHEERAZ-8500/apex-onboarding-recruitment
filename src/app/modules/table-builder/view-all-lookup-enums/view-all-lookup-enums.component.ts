...
@Component({
  selector: 'app-view-all-lookup-enums',
  templateUrl: './view-all-lookup-enums.component.html',
  styleUrl: './view-all-lookup-enums.component.scss'
})
export class ViewAllLookupEnumsComponent {
routeNUmber: number = 1;
  ...
  getAllTablesList() {
    this.routeNUmber = 1;
    this.loader.show();
    this.apiService.getAllLookupEnums().subscribe((res: any) => {
